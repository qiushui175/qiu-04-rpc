...
import com.qiu.rpc.fault.tolerant.TolerantStrategyKey;
...
public class RpcConfig {
    ...
    private Integer serverPort = 18083;
    ...
    private String tolerantStrategy = TolerantStrategyKey.FAIL_SAFE.getKey();
}
